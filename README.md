...
- Last.fm's API endpoint also provides a `count` attribute defined as "a weighted count of how often the tag was applied, with a maximum of 100". However, the values were not evenly distributed among the tags, as multiple tags could share the maximum count of 100. To ensure a fair distribution of weight among the top tags, the counts were normalised. For example, if an artist had two tags with counts of 100, these were assigned equal weights of 0.5 each.
